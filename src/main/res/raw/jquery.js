(function (window, undefined) {
    ...
    if (!jQuery.support.changeBubbles) {
        ...
        jQuery.event.special.change = {
            filters: {
                focusout: testChange, click: function (e) {
                    var elem = e.target, type = elem.type;
    ...
    /*! * Sizzle CSS Selector Engine - v1.0 * Copyright 2009, The Dojo Foundation * Released under the MIT, BSD, and GPL Licenses. * More information: http: */
    (function () {
    ...
    jQuery.extend({
        ...
        ajaxSettings: {
            ...
            processData: true,
            async: true, /* timeout: 0, data: null, username: null, password: null, traditional: false, */
    ...
    jQuery.fn.extend({
        position: function () {
            ...
            var elem = this[0], offsetParent = this.offsetParent(), offset = this.offset(), parentOffset = /^body|html$/i.test(offsetParent[0].nodeName) ? {
                top: 0,
                left: 0
            } : offsetParent.offset();
