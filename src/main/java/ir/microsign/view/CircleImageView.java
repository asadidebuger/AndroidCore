...
public class CircleImageView extends ImageView {
	...
	public void onDraw(Canvas canvas) {
		...
		if (!isInEditMode()) {
			canvasSize =getMeasuredWidth();// canvas.getWidth();
			if (getMeasuredHeight()/*canvas.getHeight()*/ < canvasSize) {
				canvasSize =getMeasuredHeight();// canvas.getHeight();
			}
		}
