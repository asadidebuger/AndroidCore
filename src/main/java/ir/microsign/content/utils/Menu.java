package ir.microsign.content.utils;
 ...
 */
public class Menu {
    public static MenuItem mFirstPage, mAddFav, mRemoveFav, mFav, mSearch, mShowImages, mExit, mSettings, mReshape, mCleanImages, mCleanAll, mReport, mAbout, mShare, mClean, mCheckUpdate, mUserProfile, mNotifications, mPurchase;
    static MenuItem[] mMenuItemsRight = null;
    static MenuItem[] mMenuItemsLeft = null;

    static void inIt() {
        mAbout = new MenuItem(20, R.string.menu_title_about_us, R.string.menu_desc_about_us, R.drawable.icon_about);
        ...
        mSearch = new MenuItem(4, R.string.menu_title_search, R.string.menu_desc_search, R.drawable.icon_search);
        ...
        mNotifications = new MenuItem(21, R.string.menu_title_notification, R.string.menu_desc_notification, R.drawable.icon_notifications);
