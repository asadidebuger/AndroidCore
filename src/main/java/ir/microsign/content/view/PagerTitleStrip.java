 ...
 */
public class PagerTitleStrip extends ViewGroup implements PagerView.Decor {
...
//		if (isInEditMode()) return;
    ...
    protected void onAttachedToWindow() {
        ...
        if (!(parent instanceof PagerView)) {
            throw new IllegalStateException(
                    "PagerTitleStrip must be a direct child of a ViewPager.");
        }

        final PagerView pager = (PagerView) parent;
...
//		setTypeface();
        ...
        Text.setText(mPrevText, text != null ? text.toString() : "", Font.TextPos.h2, false);

        CharSequence title = (adapter != null && currentItem < itemCount ?
                adapter.getPageTitle(currentItem) : null);
        Text.setText(mCurrText, title != null ? title.toString() : "", Font.TextPos.h1, false);
        ...
        Text.setText(mNextText, text != null ? text.toString() : "", Font.TextPos.h2);
        // Measure everything
    ...
    private class PageListener extends DataSetObserver implements PagerView.OnPageChangeListener,
            PagerView.OnAdapterChangeListener {
        ...
        public void onPageSelected(int position) {
            if (mScrollState == PagerView.SCROLL_STATE_IDLE) {
