...
public final class Converter {
    ...
    public static Date Convert(Date date, Date.Type input, Date.Type output) {
        if (input == output) return date;
        Date out = null;
        if (input == Date.Type.gregorian) {
            out = (output == Date.Type.islamic) ? civilToIslamic(date) : civilToPersian(date);
        }else
        if (input == Date.Type.persian) {
            out = (output == Date.Type.islamic) ? persianToIslamic(date) : persianToCivil(date);
        }else
        if (input == Date.Type.islamic) {
            out = (output == Date.Type.persian) ? islamicToPersian(date) : islamicToCivil(date);
        }
        out.hour = date.hour;
        out.minute = date.minute;
        out.second = date.second;
        return out;
    }

    public static  IslamicDate civilToIslamic(Date civil) {
        return jdnToIslamic(civilToJdn(civil));
    }

    public static  long civilToJdn(Date civil) {
    ...
    public static  PersianDate civilToPersian(Date civil) {
        return jdnToPersian(civilToJdn(civil),civil.hour,civil.minute,civil.second,civil.milisecond);
    }
    ...
    public static  CivilDate islamicToCivil(Date islamic) {
        return jdnToCivil(islamicToJdn(islamic));
    }

    public static  long islamicToJdn(Date islamic) {
    ...
    public static  PersianDate islamicToPersian(Date islamic) {
    ...
    public static  PersianDate jdnToPersian(long jdn,int...time) {
        ...
        return new PersianDate(year, month, day,hours,minutes,seconds,ms);
    }
    ...
    public static  CivilDate persianToCivil(Date persian) {
        return jdnToCivil(persianToJdn(persian));
    }

    public static  IslamicDate persianToIslamic(Date persian) {
    ...
    public static long persianToJdn(Date persian) {
