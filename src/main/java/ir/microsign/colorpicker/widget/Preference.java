package ir.microsign.colorpicker.widget;
...
public class Preference extends android.preference.Preference {
    ...
    public Preference(Context context, AttributeSet attrs) {
        ...
        supportsAlpha = ta.getBoolean(R.styleable.Preference_supportsAlpha, false);
    ...
    protected void onClick() {
        new ColorPickerView(getContext(), value, supportsAlpha, new ColorPickerView.OnColorPickerListener() {
            @Override
